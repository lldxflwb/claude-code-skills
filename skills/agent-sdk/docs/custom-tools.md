...
Source: https://docs.anthropic.com/en/agent-sdk/custom-tools
Updated: 2026-03-30
...
This tool converts values between units of length, temperature, and weight. A user can ask "convert 100 kilometers to miles" or "what is 72F in Celsius," and Claude picks the right unit type and units from the request.
