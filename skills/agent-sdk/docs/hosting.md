...
Source: https://docs.anthropic.com/en/agent-sdk/hosting
Updated: 2026-03-30
...
> **Note:** For security hardening beyond basic sandboxing (including network controls, credential management, and isolation options), see [Secure Deployment](/docs/en/agent-sdk/secure-deployment).
